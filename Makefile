...
user-venv: ## create .venv file with name of conda env
	echo $${PWD}/.nox/nox-bootstrap/envs/dev > .venv
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source nox_bootstrap -m pytest
	coverage report -m
	coverage html
...
version-import: ## check version from python import
	-python -c 'import nox_bootstrap; print(nox_bootstrap.__version__)'
...
tuna-import: ## Analyze load time for module
	python -X importtime -c 'import nox_bootstrap' 2> tuna-loadtime.log
