...
Report bugs at <https://github.com/wpk-nist-gov/nox-bootstrap/issues>.
...
`nox-bootstrap` could always use more documentation, whether as part of the
official `nox-bootstrap` docs, in docstrings, or even on the web in blog posts,
articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at
<https://github.com/wpk-nist-gov/nox-bootstrap/issues>.
...
Ready to contribute? Here's how to set up `nox-bootstrap` for local development.

- Fork the `nox-bootstrap` repo on GitHub.

- Clone your fork locally:

  ```bash
  git clone git@github.com:your_name_here/nox-bootstrap.git
  ```
  ...
  ```bash
  git clone --recursive-submodules git@github.com:your_name_here/nox-bootstrap.git
  ```
